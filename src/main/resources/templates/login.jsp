...
<html 
	...
	<body style="background-color:#ededed;">
		...
		<div class="container-fluid">
			<div class="row col-lg-4 col-lg-offset-4" style="margin-top: 10px;background-color:#fff;padding:20px;border:solid 4px #ddd;">
				...
				<form th:action="@{/login}" method="POST" class="form-signin">
					<h3 class="form-signin-heading" th:text="Login" style="text-align: center; font-size:30px"></h3> <br /> 
